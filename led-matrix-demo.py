...
def demo(w, h, block_orientation, rotate):
    ...
    with canvas(device) as draw:
        ...
        text(draw, (0, 1), "Hello", fill="white", font=proportional(CP437_FONT))
        #text(draw, (2, 10), "World", fill="white", font=proportional(CP437_FONT))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--width', type=int, default=32, help='Width') #8
